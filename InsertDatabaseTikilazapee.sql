...
values ('Admin',null,'admin123@123.admin', 2, null, null, '15-5-2024', 1),
		...
		(N'Nguyễn Mạnh Hùng', '0123112233', 'hungnmhe176678@fpt.edu.vn', 1, 'Ha Nam', '04-11-2003', null,  2),
		(N'Bùi Đức Tùng', '09999999999', 'tungbdhe170285@fpt.edu.vn', 1, 'Thach That - Ha Noi','01-01-2003', null, 2),
...
values(1,'admin','admin','05-15-2024',1),
		(2,'anhpro123','Anhpro123','05-14-2024',0),
		(3,'khanhnguyen','khanh123', '05-14-2024', 0),
		(4,'hungnguyen','hung123', '05-14-2024',0),
		(5,'tungbui', 'tung123', '05-14-2024',0),
		(6,'vietthinh', 'thinh123','05-14-2024',0),
		(7,'vingungoc', 'vingungoc', '05-14-2024',0),
		(8,'truongtran', 'truong123', '05-14-2024',0),
		(9, 'phuongmi', 'phuong123', '05-14-2024',0);
